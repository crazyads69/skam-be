/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 91ef6efa7f82f4ed83132e30952d64d3)
// Runtime types generated with workerd@1.20251210.0 2026-01-02 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
	}
	interface Env {
		SKAM_CACHE: KVNamespace;
		skam: R2Bucket;
		skam_db_dev: D1Database;
		SKAM_RATE_LIMIT: RateLimit;
		SKAM_RATE_LIMIT_UPLOAD: RateLimit;
		SKAM_RATE_LIMIT_SUBMIT: RateLimit;
		SKAM_RATE_LIMIT_SEARCH: RateLimit;
	}
}
